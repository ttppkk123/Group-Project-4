...
$testimonials = [
    ...
    [
        "name" => "მანანა შერვაშიძე",
        "subtitle" => "პაციენტი",
        "text" => "სანდო, პროფესიული და მომხმარებელზე ორიენტირებულ მომსახურება. ცენტრი ზრუნავს კლიენტების მენტალურ კეთილდღეობაზე უმაღლესი სტანდარტებით."
    ],
    [
        "name" => "გურამ ბენაშვილი",
        "subtitle" => "პაციენტი",
        "text" => "უსაფრთხო სივრცე ურთიერთობების სირთულეების გასაზიარებლად და დახმარების მისაღებად. ფსიქოლოგი ორიენტირებულია პარტნიორებს შორის კომუნიკაციის გაუმჯობესებასა და ურთიერთობის გაძლიერებაზე."
    ]
];
...
$news = [
    ...
    ["img" => "images/post4.jpg", "text" => "ცენტრის განახლებული სამუშაო საათები და მიღების დღეები"]
];
